...
impl EventBroadcaster {
    ...
    pub fn emit_session_created(&self, session: ccm_proto::daemon::SessionInfo) {
        self.broadcast(Event {
            event: Some(ccm_proto::daemon::event::Event::SessionCreated(
                SessionCreatedEvent {
    ...
    pub fn emit_session_destroyed(&self, session_id: String, repo_id: String, branch: String) {
        self.broadcast(Event {
            event: Some(ccm_proto::daemon::event::Event::SessionDestroyed(
    ...
    pub fn emit_session_name_updated(
        ...
        self.broadcast(Event {
            event: Some(ccm_proto::daemon::event::Event::SessionNameUpdated(
    ...
    pub fn emit_session_status_changed(
        ...
        self.broadcast(Event {
            event: Some(ccm_proto::daemon::event::Event::SessionStatusChanged(
